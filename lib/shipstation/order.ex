defmodule Shipstation.Order do
  ...
  through the API.
  """
  @spec upsert(order :: Shipstation.Structs.Order.t) :: Shipstation.Client.response_type
  def upsert(order = %Shipstation.Structs.Order{}) do
    uri = %{Shipstation.Client.base_uri | path: "/orders/createorder"}
    Shipstation.Client.call_api(:post, uri, order)
  end
  ...
  """
  @spec upsert(orders :: [Shipstation.Structs.Order.t]) :: Shipstation.Client.response_type
  def upsert(orders) when is_list(orders) do
    uri = %{Shipstation.Client.base_uri | path: "/orders/createorders"}
    Shipstation.Client.call_api(:post, uri, orders)
  end
  ...
  def get(id) do
    uri = %{Shipstation.Client.base_uri | path: "/orders/#{id}"}
  ...
  """
  @spec delete(id :: integer) :: Shipstation.Client.response_type
  def delete(id) do
    uri = %{Shipstation.Client.base_uri | path: "/orders/#{id}"}
  ...
  def list() do
    uri = %{Shipstation.Client.base_uri | path: "/orders"}
    Shipstation.Client.call_api(:get, uri, %{})
  end
  ...
  """
  @spec list(order_filter :: Shipstation.Structs.OrderFilter.t) :: Shipstation.Client.response_type
  def list(params = %Shipstation.Structs.OrderFilter{}) do
    uri = %{Shipstation.Client.base_uri | path: "/orders"}
    Shipstation.Client.call_api(:get, uri, params)
  end
  ...
  """
  @spec list_by_tag(order_status :: String.t, tag_id :: integer, page :: non_neg_integer, page_size :: non_neg_integer) :: Shipstation.Client.response_type
  def list_by_tag(order_status, tag_id, page, page_size) do
    uri = %{Shipstation.Client.base_uri | path: "/orders/listbytag"}
    Shipstation.Client.call_api(:get, uri, %{orderStatus: order_status, tagId: tag_id, page: page, pageSize: page_size})
  end

  @doc ~s"""
  Adds a tag to an order
  """
  @spec add_tag(order_id :: integer, tag_id :: integer) :: Shipstation.Client.response_type
  def add_tag(order_id, tag_id) do
    uri = %{Shipstation.Client.base_uri | path: "/orders/addtag"}
    Shipstation.Client.call_api(:post, uri, %{orderId: order_id, tagId: tag_id})
  end

  @doc ~s"""
  Removes a tag from an order
  """
  @spec remove_tag(order_id :: integer, tag_id :: integer) :: Shipstation.Client.response_type
  def remove_tag(order_id, tag_id) do
    uri = %{Shipstation.Client.base_uri | path: "/orders/removetag"}
    Shipstation.Client.call_api(:post, uri, %{orderId: order_id, tagId: tag_id})
  end
  ...
  """
  @spec assign_user(order_id :: integer, user_id :: integer) :: Shipstation.Client.response_type
  def assign_user(order_id, user_id) when is_number(order_id),
    do: assign_user([order_id], user_id)

  @spec assign_user(order_ids :: [integer], user_id :: integer) :: Shipstation.Client.response_type
  def assign_user(order_ids, user_id) when is_list(order_ids) do
    uri = %{Shipstation.Client.base_uri | path: "/orders/assignuser"}
    Shipstation.Client.call_api(:post, uri, %{orderIds: order_ids, userId: user_id})
  end

  @doc ~s"""
  Unassigns a user from an order.
  """
  @spec unassign_user(order_id :: integer) :: Shipstation.Client.response_type
  def unassign_user(order_id) when is_number(order_id),
    do: unassign_user([order_id])

  @spec unassign_user(order_ids :: [integer]) :: Shipstation.Client.response_type
  def unassign_user(order_ids) when is_list(order_ids) do
    uri = %{Shipstation.Client.base_uri | path: "/orders/unassignuser"}
    Shipstation.Client.call_api(:post, uri, %{orderIds: order_ids})
  end
  ...
  """
  @spec create_label(order :: Shipstation.Structs.Label.t) :: Shipstation.Client.response_type
  def create_label(params = %Shipstation.Structs.Label{}) do
    uri = %{Shipstation.Client.base_uri | path: "/orders/createlabelfororder"}
  ...
  Shipment.
  """
  @spec hold_until(order_id :: integer, hold_until_date :: String.t) :: Shipstation.Client.response_type
  def hold_until(order_id, hold_until_date) do
    uri = %{Shipstation.Client.base_uri | path: "/orders/holduntil"}
    Shipstation.Client.call_api(:post, uri, %{orderId: order_id, holdUntilDate: hold_until_date})
  end
  ...
  """
  @spec restore_from_on_hold(order_id :: integer) :: Shipstation.Client.response_type
  def restore_from_on_hold(order_id) do
    uri = %{Shipstation.Client.base_uri | path: "/orders/restorefromhold"}
    Shipstation.Client.call_api(:post, uri, %{orderId: order_id})
  end

  @doc ~s"""
  Marks an order as shipped without creating a label in ShipStation.
  """
  @spec mark_as_shipped(params :: Shipstation.Structs.OrderShipped.t) :: Shipstation.Client.response_type
  def mark_as_shipped(params = %Shipstation.Structs.OrderShipped{}) do
    uri = %{Shipstation.Client.base_uri | path: "/orders/markasshipped"}
    Shipstation.Client.call_api(:post, uri, params)
  end
